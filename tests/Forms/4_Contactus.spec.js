...
test('check the dropdown for jobseeker', async ({ page }) => {
  await page.goto('https://pattemdigital.com/')
  await expect(page.locator('#section__wrapper--contact-us')).toBeVisible();
  await page.locator('#section__wrapper--contact-us').click();
  await page.getByPlaceholder('Enter Your Name');
  await page.getByPlaceholder('Enter Your Name').fill('surya');
  await page.getByPlaceholder ('Enter Your Email Address').click();
  await page.getByPlaceholder('Enter your Email Address'). fill('SuRya@playwright.com');
  await page.getByPlaceholder('Enter Phone Number').click();
  await page.getByPlaceholder('Enter Phone Number').fill('9876543210');
    
  await page.locator('#lookingFor').click();
  ...
  await page.locator('#section__wrapper--contact-us #button--submit-contact-us').click();
...
test('Fill PattemDigital Contact Form vendor', async ({ page }) => {
    ...
    await page.getByPlaceholder('Enter Your Name').fill('surya');
    await page.getByPlaceholder ('Enter Your Email Address').click();
    await page.getByPlaceholder('Enter your Email Address'). fill('vendor@playwright.com');
    await page.getByPlaceholder('Enter Phone Number').click();
    await page.getByPlaceholder('Enter Phone Number').fill('9876543210');
